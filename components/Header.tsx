          ...
          <div className="flex items-center justify-between md:justify-evenly relative">
            ...
            >
              <div className="relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-primary-400 to-accent-400 rounded-lg blur-lg opacity-30 -z-10" />
              </div>
              <div>
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-primary-400 to-accent-400 rounded-lg blur-lg opacity-30 -z-10"></div>
            </div>
            ...
            {[
              ...
              <Link key={item.href} href={item.href}>
                <motion.span
                  ...
                  className="text-neural-300 hover:text-primary-300 transition-colors duration-300 font-medium cursor-pointer relative group"
                >
                  {item.label}
...
=======
                    ...
                    className="hover:opacity-80 transition-opacity duration-300"
                  />
                  <div className="absolute inset-0 bg-gradient-to-r from-primary-500/20 to-accent-500/20 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-lg"></div>
                </motion.div>
              ))}
            </motion.div>
            ...
            <Link href="#contact">
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="relative overflow-hidden px-6 py-2 bg-gradient-to-r from-primary-500 to-accent-500 rounded-xl text-white font-medium transition-all duration-300 hover:shadow-lg hover:shadow-primary-500/25 group"
              >
                <span className="relative z-10 flex items-center space-x-2">
                  <span className="hidden sm:inline">Get in Touch</span>
            ...
            <motion.button
              ...
              animate={{ opacity: 1 }}
              transition={{ duration: 0.8, delay: 0.8 }}
              className="lg:hidden p-2 text-neural-300 hover:text-primary-300 transition-colors duration-300"
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" />
              </svg>
        ...
        {/* Data Flow Animation */}
        <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary-400/50 to-transparent animate-data-stream"></div>
      </div>
    </header>
>>>>>>> c42810109baddd901e8b383737fde41537b08dcb
  );

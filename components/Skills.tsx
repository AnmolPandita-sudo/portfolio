    ...
    >
      ...
      <div className="relative z-10 w-full">
        <div className="text-center mb-5">
          ...
          <p className="text-neural-100 text-sm md:text-base lg:text-lg xl:text-xl font-semibold">
            ...
            {skills?.map((skill, index) => (
              ...
              >
                <div className="relative">
                  {/* Skill icon with neural glow */}
                  <div className="relative neural-glow">
                    <motion.img
                      whileHover={{ scale: 1.1, rotateY: 15 }}
                      className="rounded-2xl border-2 border-neural-600/50 object-cover w-10 h-10 xl:w-20 xl:h-20 filter group-hover:brightness-110 transition-all duration-300 ease-in-out shadow-lg group-hover:shadow-xl"
                      src={
                        skill.image
                    ...
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out">
                      <div className="w-full h-full rounded-2xl bg-gradient-to-br from-neural-900/90 to-neural-800/90 backdrop-blur-sm flex flex-col items-center justify-center border-2 border-primary-500/50 px-2 text-center ">
                        <div
                ...
                <div className="mt-3 text-center">
                  <p className="text-base sm:text-sm md:text-base text-neural-200 font-medium leading-tight font-mono group-hover:text-primary-300 transition-colors duration-300">
                    {skill.title}
                  </p>
                </div>
